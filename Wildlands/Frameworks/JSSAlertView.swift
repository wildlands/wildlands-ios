...
class JSSAlertView: UIViewController {
    ...
    var titleFont = "Wildlands-Regular"
    var textFont = "Roboto-Regular"
    var buttonFont = "Roboto-Bold"
    ...
    override func viewDidLayoutSubviews() {
        ...
        if self.textView != nil {
            ...
            let textSize = CGSize(width: contentWidth, height: CGFloat.max)
            ...
            self.textView.frame = CGRect(x: self.padding, y: yPos, width: self.alertWidth - (self.padding*2), height: (ceil(textRect.size.height)*2 + self.padding))
        ...
        var constraint = NSLayoutConstraint(item: self.containerView, attribute: NSLayoutAttribute.CenterX, relatedBy: NSLayoutRelation.Equal, toItem: self.view, attribute: NSLayoutAttribute.CenterX, multiplier: 1.0, constant: 0.0)
        
        self.view.addConstraint(constraint)
        
        constraint = NSLayoutConstraint(item: self.containerView, attribute: NSLayoutAttribute.CenterY, relatedBy: NSLayoutRelation.Equal, toItem: self.view, attribute: NSLayoutAttribute.CenterY, multiplier: 1.0, constant: 0.0)
        
        self.view.addConstraint(constraint)
    
    }
    
    func show(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil, color: UIColor?=nil, iconImage: UIImage?=nil, delegate: JSSAlertViewDelegate?=nil) -> JSSAlertViewResponder {
        ...
        UIView.animateWithDuration(0.5, delay: 0.05, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.8, options: nil, animations: {
